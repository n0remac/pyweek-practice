...
from Constants.Physics import DEFAULT_DAMPING, GRAVITY, PLAYER_FRICTION, PLAYER_MASS, PLAYER_MAX_HORIZONTAL_SPEED, \
	PLAYER_MAX_VERTICAL_SPEED, WALL_FRICTION, DYNAMIC_ITEM_FRICTION
